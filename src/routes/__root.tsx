  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        ...
        <p className="mt-2 text-sm text-muted-foreground">La page que vous recherchez n'existe pas.</p>
        <div className="mt-6">
...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { name: "twitter:title", content: "JDC Distribution — Plateforme de commande" },
      { property: "og:description", content: "Solution de commande centralisée pour vos points de vente." },
      { name: "twitter:description", content: "Solution de commande centralisée pour vos points de vente." },
